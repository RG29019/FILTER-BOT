...
BOT_TOKEN = environ.get('BOT_TOKEN', "7647882778:AAF1K22skNPoZ3NRSG_kPswgNGUv2tmn6aM")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002316840805')).split()]  # For Multiple Id Use One Space Between Each.
